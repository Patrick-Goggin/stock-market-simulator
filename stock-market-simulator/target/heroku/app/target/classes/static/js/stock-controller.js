...
//            var shares = angular.element('#details-shares').val();
//            var amount = angular.element('#details-shares-value').val();
//                              //  var t = angular.element('#t-details').val();
//                                var number = angular.element('#details-shares').val();
//                                var parameter = JSON.stringify({type: "Transaction", symbol: t, shareCount: number, funds: amount});
//                                var f;
